package net.corda.accord.plugin

import net.corda.core.messaging.CordaRPCOps
import net.corda.accord.api.PromissoryNoteApi
...
class IOUPlugin : WebServerPluginRegistry {
     ...
     */
    override val webApis: List<Function<CordaRPCOps, out Any>> = listOf(Function(::PromissoryNoteApi))
