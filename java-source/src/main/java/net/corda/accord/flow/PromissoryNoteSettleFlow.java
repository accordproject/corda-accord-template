...
public class PromissoryNoteSettleFlow {
    ...
    public static class InitiatorFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            } else if (amount.getQuantity() > (inputStateToSettle.getAmount().getCurrency().getQuantity() - inputStateToSettle.paid.getQuantity())) {
            ...
            if (amount.getQuantity() < inputStateToSettle.getAmount().getCurrency().getQuantity()) {
