...
//    }
    ...
    /**
     * Task 3.
     * Now we need to ensure that only one {@link PromissoryNoteState} is issued per transaction.
...
//    }
    ...
    /**
     * Task 4.
     * Now we need to consider the properties of the {@link PromissoryNoteState}. We need to ensure that an IOU should always have a
     * positive value.
     ...
     *   to an {@link PromissoryNoteState}. E.g.
     *
     *       XState state = (XState)tx.getOutputStates().get(0)
     *
     * - When checking the [PromissoryNoteState.getAmount()] property is greater than zero, you need to check the
     *   [PromissoryNoteState.getAmount().getQuantity()] field.
     */
//    @Test
...
//    }
     ...
     * Hint:
     * - You can use the [PromissoryNoteState.getLender()] and [PromissoryNoteState.getBorrower()] properties.
...
//    }
    ...
    /**
     * Task 6.
     * The list of public keys which the commands hold should contain all of the participants defined in the {@link PromissoryNoteState}.
     ...
     * TODO: Add a contract constraint to check that all the required signers are {@link PromissoryNoteState} participants.
     * Hint:
