 ...
 */
public class PromissoryNoteStateTests {

    /**
     * Task 1.
     * TODO: Add an 'amount' property of type {@link Amount} to the {@link PromissoryNoteState} class to get this test to pass.
...
//        Field amountField = PromissoryNoteState.class.getDeclaredField("amount");
...
//    }
    ...
    /**
     * Task 2.
     * TODO: Add a 'lender' property of type {@link Party} to the {@link PromissoryNoteState} class to get this test to pass.
     */
//    @Test
//    public void hasLenderFieldOfCorrectType() throws NoSuchFieldException {
//        // Does the lender field exist?
//        Field lenderField = PromissoryNoteState.class.getDeclaredField("lender");
...
//    }
    ...
    /**
     * Task 3.
     * TODO: Add a 'borrower' property of type {@link Party} to the {@link PromissoryNoteState} class to get this test to pass.
     */
//    @Test
//    public void hasBorrowerFieldOfCorrectType() throws NoSuchFieldException {
//        // Does the borrower field exist?
//        Field borrowerField = PromissoryNoteState.class.getDeclaredField("borrower");
...
//    }
    ...
    /**
     * Task 4.
     * TODO: Add a 'paid' property of type {@link Amount] to the {@link PromissoryNoteState } class to get this test to pass.
     * Hint:
     * - We would like this property to be initialised to a zero amount of Currency upon creation of the {@link PromissoryNoteState }.
     * - You can use the {@link Currencies#POUNDS} function from Currencies to create an amount of pounds e.g. 'Currencies.POUNDS(10)'.
     * - This property keeps track of how much of the initial [PromissoryNoteState.amount] has been settled by the borrower
     *
     * - We need to make sure that the [PromissoryNoteState.paid] property is of the same currency type as the
     *   [PromissoryNoteState.amount] property. You can create an instance of the {@link Amount} class that takes a zero value and a token
     *   representing the currency - which should be the same currency as the [PromissoryNoteState.amount] property.
     */
//    @Test
//    public void hasPaidFieldOfCorrectType() throws NoSuchFieldException {
//        // Does the paid field exist?
//        Field paidField = PromissoryNoteState.class.getDeclaredField("paid");
...
//    }
    ...
    /**
     * Task 5.
     * TODO: Include the lender within the {@link PromissoryNoteState#getParticipants()} list
     * Hint: [Arrays.asList()] takes any number of parameters and will add them to the list
     */
//    @Test
//    public void lenderIsParticipant() {
//        PromissoryNoteState iouState = new PromissoryNoteState(Currencies.POUNDS(0), ALICE.getParty(), BOB.getParty());
//        assertNotEquals(iouState.getParticipants().indexOf(ALICE.getParty()), -1);
//    }

    /**
     * Task 6.
     * TODO: Similar to the last task, include the borrower within the [PromissoryNoteState.participants] list
     */
//    @Test
...
//        assert(LinearState.class.isAssignableFrom(PromissoryNoteState.class));
//    }
     ...
     * - Create a new public constructor that creates an {@link PromissoryNoteState} with a newly generated [linearId].
...
//        Field linearIdField = PromissoryNoteState.class.getDeclaredField("linearId");
//
...
//
//        List<Field> fields = Arrays.asList(PromissoryNoteState.class.getDeclaredFields());
//
//        int amountIdx = fields.indexOf(PromissoryNoteState.class.getDeclaredField("amount"));
//        int lenderIdx = fields.indexOf(PromissoryNoteState.class.getDeclaredField("lender"));
//        int borrowerIdx = fields.indexOf(PromissoryNoteState.class.getDeclaredField("borrower"));
//        int paidIdx = fields.indexOf(PromissoryNoteState.class.getDeclaredField("paid"));
//        int linearIdIdx = fields.indexOf(PromissoryNoteState.class.getDeclaredField("linearId"));
//
...
//    }
    ...
    /**
     * Task 10.
     * TODO: Add a helper method called [pay] that can be called from an {@link PromissoryNoteState} to settle an amount of the IOU.
     * Hint:
     * - You will need to increase the [PromissoryNoteState.paid] property by the amount the borrower wishes to pay.
     * - Add a new function called [pay] in {@link PromissoryNoteState}. This function will need to return an {@link PromissoryNoteState}.
...
//    }
    ...
    /**
     * Task 11.
     * TODO: Add a helper method called [withNewLender] that can be called from an {@link }PromissoryNoteState} to change the IOU's lender.
...
//        try {
//            Constructor<PromissoryNoteState> contructor = PromissoryNoteState.class.getConstructor(Amount.class, Party.class, Party.class);
...
//        try {
//            Constructor<PromissoryNoteState> contructor = PromissoryNoteState.class.getDeclaredConstructor(Amount.class, Party.class, Party.class, Amount.class, UniqueIdentifier.class);
//        } catch( NoSuchMethodException name ) {
